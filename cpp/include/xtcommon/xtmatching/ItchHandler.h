#pragma once
#ifndef XT_ITCH_HANDLER_H
#define XT_ITCH_HANDLER_H
...
*
* \brief  Provide class for nasdaq itch handler.
*
* \description
*	Designed for use for nasdaq itch handler.
*/
...
namespace XT
{
	...
	/*!
		...
		Not thread-safe.
	*/
	class XT_COMMON_API ITCHHandler
	{
	public:
		ITCHHandler() { Reset(); }
...
//////
	...
	{
		stream << "SystemEventMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; EventCode=" << XT::WriteChar(message.EventCode)
			<< ")";
		return stream;
	}
	...
	{
		stream << "StockDirectoryMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; MarketCategory=" << XT::WriteChar(message.MarketCategory)
			<< "; FinancialStatusIndicator=" << XT::WriteChar(message.FinancialStatusIndicator)
			<< "; RoundLotSize=" << message.RoundLotSize
			<< "; RoundLotsOnly=" << XT::WriteChar(message.RoundLotsOnly)
			<< "; IssueClassification=" << XT::WriteChar(message.IssueClassification)
			<< "; IssueSubType=" << XT::WriteString(message.IssueSubType)
			<< "; Authenticity=" << XT::WriteChar(message.Authenticity)
			<< "; ShortSaleThresholdIndicator=" << XT::WriteChar(message.ShortSaleThresholdIndicator)
			<< "; IPOFlag=" << XT::WriteChar(message.IPOFlag)
			<< "; LULDReferencePriceTier=" << XT::WriteChar(message.LULDReferencePriceTier)
			<< "; ETPFlag=" << XT::WriteChar(message.ETPFlag)
			<< "; ETPLeverageFactor=" << message.ETPLeverageFactor
			<< "; InverseIndicator=" << XT::WriteChar(message.InverseIndicator)
			<< ")";
		return stream;
	}
	...
	{
		stream << "StockTradingActionMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; TradingState=" << XT::WriteChar(message.TradingState)
			<< "; Reserved=" << XT::WriteChar(message.Reserved)
			<< "; Reason=" << XT::WriteChar(message.Reason)
			<< ")";
		return stream;
	}
	...
	{
		stream << "RegSHOMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; RegSHOAction=" << XT::WriteChar(message.RegSHOAction)
			<< ")";
		return stream;
	}
	...
	{
		stream << "MarketParticipantPositionMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; MPID=" << XT::WriteString(message.MPID)
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; PrimaryMarketMaker=" << XT::WriteChar(message.PrimaryMarketMaker)
			<< "; MarketMakerMode=" << XT::WriteChar(message.MarketMakerMode)
			<< "; MarketParticipantState=" << XT::WriteChar(message.MarketParticipantState)
			<< ")";
		return stream;
	}
	...
	{
		stream << "MWCBDeclineMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
	...
	{
		stream << "MWCBStatusMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
	...
	{
		stream << "IPOQuotingMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Stock=" << XT::WriteString(message.Stock)
	...
	{
		stream << "AddOrderMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
			<< "; BuySellIndicator=" << XT::WriteChar(message.BuySellIndicator)
	...
	{
		stream << "AddOrderMPIDMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
			...
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; Price=" << message.Price
			<< "; Attribution=" << XT::WriteChar(message.Attribution)
			<< ")";
		return stream;
	}
	...
	{
		stream << "OrderExecutedMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
	...
	{
		stream << "OrderExecutedWithPriceMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
			<< "; ExecutedShares=" << message.ExecutedShares
			<< "; MatchNumber=" << message.MatchNumber
			<< "; Printable=" << XT::WriteChar(message.Printable)
	...
	{
		stream << "OrderCancelMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
	...
	{
		stream << "OrderDeleteMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
	...
	{
		stream << "OrderReplaceMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
	...
	{
		stream << "TradeMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; OrderReferenceNumber=" << message.OrderReferenceNumber
	...
	{
		stream << "CrossTradeMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Shares=" << message.Shares
			...
			<< "; MatchNumber=" << message.MatchNumber
			<< "; CrossType=" << XT::WriteChar(message.CrossType)
			<< ")";
		return stream;
	}
	...
	{
		stream << "BrokenTradeMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; MatchNumber=" << message.MatchNumber
	...
	{
		stream << "NOIIMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; PairedShares=" << message.PairedShares
			<< "; ImbalanceShares=" << message.ImbalanceShares
			<< "; ImbalanceDirection=" << XT::WriteChar(message.ImbalanceDirection)
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; FarPrice=" << message.FarPrice
			<< "; NearPrice=" << message.NearPrice
			<< "; CurrentReferencePrice=" << message.CurrentReferencePrice
			<< "; CrossType=" << XT::WriteChar(message.CrossType)
			<< "; PriceVariationIndicator=" << XT::WriteChar(message.PriceVariationIndicator)
			<< ")";
		return stream;
	}
	...
	{
		stream << "RPIIMessage(Type=" << XT::WriteChar(message.Type)
			<< "; StockLocate=" << message.StockLocate
			<< "; TrackingNumber=" << message.TrackingNumber
			<< "; Timestamp=" << message.Timestamp
			<< "; Stock=" << XT::WriteString(message.Stock)
			<< "; InterestFlag=" << XT::WriteChar(message.InterestFlag)
			<< ")";
		return stream;
	}
	...
	{
		stream << "UnknownMessage(Type=" << XT::WriteChar(message.Type) << ")";
		return stream;
	}
