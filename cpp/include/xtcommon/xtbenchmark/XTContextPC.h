#pragma once
#ifndef XT_CONTEXT_PC_H
#define XT_CONTEXT_PC_H
...
*
* \brief  Provide context producer-consumer .
*
* \description
*	Designed for context producer-consumer.
*/
...
namespace XT
{
	...
	*/
	class XT_COMMON_API ContextPC : public Context
	{
