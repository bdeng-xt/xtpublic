#pragma once
#ifndef XT_LAUNCHER_CONSOLE_H
#define XT_LAUNCHER_CONSOLE_H

/**
* \file LauncherConsole.h
*
* \author Bin Deng (bdeng@xtal-tech.com)
*
* \brief  Provide a console launcher class.
*
* \description
*	Designed for console launcher.
*/
...
namespace XT
{
	...
	*/
	class XT_COMMON_API LauncherConsole : public Launcher
	{
	public:
