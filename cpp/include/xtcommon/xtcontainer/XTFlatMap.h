...
*
* \brief  Provide class for flat map.
*
* \description
*	Designed for use for flat map.
*/
...
//////
	...
	{
		return std::lower_bound(begin(), end(), key, [this](TKey key1, TKey key2) { return this->compare(key1, key2); });
	}
	...
	{
		return std::upper_bound(begin(), end(), key, [this](TKey key1, TKey key2) { return this->compare(key1, key2); });
	}
	...
	{
		return std::equal_range(begin(), end(), key, [this](TKey key1, TKey key2) { return this->compare(key1, key2); });
	}
