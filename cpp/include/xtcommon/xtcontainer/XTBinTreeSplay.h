#pragma once
#ifndef XT_BINTREE_SPLAY_H
#define XT_BINTREE_SPLAY_H

/**
* \file XTBinTreeSplay.h
*
* \author Bin Deng (bdeng@xtal-tech.com)
*
* \brief  Provide class for splay binary tree.
*
* \description
*	Designed for use for splay binary tree.
*/
