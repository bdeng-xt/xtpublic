#pragma once
#ifndef XT_TOKEN_BUCKET_H
#define XT_TOKEN_BUCKET_H

/**
* \file XTTokenBucket.h
*
* \author Bin Deng (bdeng@xtal-tech.com)
*
* \brief  Provide a token bucket class.
*
* \description
*	Designed for token bucket.
*/
...
namespace XT
{
	...
	*/
	class XT_COMMON_API TokenBucket
	{
	public:
