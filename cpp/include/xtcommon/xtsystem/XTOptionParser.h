...
class XT_COMMON_API OptionContainer {
  public:
...
class XT_COMMON_API OptionParser : public OptionContainer {
  public:
    OptionParser();
...
class XT_COMMON_API OptionGroup : public OptionContainer {
  public:
